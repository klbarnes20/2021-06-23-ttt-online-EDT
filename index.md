...
humandate: "June 23 - 24, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9 am to 5 pm N. American Eastern Daylight Time"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Kelly Barnes", "Sarah Stevens", "Zhian Kamvar"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["kbarnes@carpentries.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad:             # optional: URL for the workshop Etherpad if there is one
eventbrite: 143825334447          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
locations:
  - venue: "Online"
